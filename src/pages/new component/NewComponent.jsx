...
const NewComponent = () => {
  return (
    <>
      <section class="bg-[#100650] w-full ">
        <div class="flex justify-between px-[32.96px] md:px-32 pt-[56px] pb-[352px] md:py-40 flex-col md:flex-row bg-[url('../public/art.svg')] bg-origin-border bg-no-repeat bg-right-bottom md:bg-right-top">
          <div className="w-full md:w-2/3">
            ...
            <h3 class="capitalise leading-[62.4px] mt-[19.04px] font-black font-Satoshi text-[51.2px] md:text-[56px] text-white">
            ...
            "
            >
              <p class="font-Inter text-white leading-[25.6px] md:text-lg font-normal">
      ...
      <section class="bg-[#100650] w-full overflow-hidden">
        <div class="flex px-[32.96px] lg:px-32 pt-[56px] pb-[352px] md:py-40 flex-col lg:flex-row bg-[url(./assets/vector-mobile.svg)] lg:bg-[url('./assets/vector-ppc.svg')] bg-origin-border bg-no-repeat bg-right-top lg:bg-right-bottom relative">
          <div className="w-full md:w-2/3 ">
            <h3 class="capitalise leading-[62.4px] font-black font-Satoshi text-[51.2px] md:text-[56px] text-white">
            ...
            "
            >
              <div class="flex gap-4 items-center font-Inter text-white leading-[25.6px] text-lg font-normal mt-14">
                <img src={Pc} alt="" />
                <p>
